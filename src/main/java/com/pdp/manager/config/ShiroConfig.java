...
import com.pdp.manager.filter.KickoutSessionFilter;
import com.pdp.manager.shiro.MyRealm;
...
//        filterMap.put("/user/login", "anon");
        ...
        filterMap.put("/login/loginCA", "anon");
//        filterMap.put("/services/**", "anon"); //webservice测试放行
//        filterMap.put("/medicalOrgUser/**", "anon");
//        filterMap.put("/medicalOrg/**", "anon");
//        filterMap.put("/medicalCase/**", "anon");
//        filterMap.put("/logInfo/**", "anon");
        filterMap.put("/api/getToken", "anon");
        filterMap.put("/api/verifyRecipel", "anon"); 
        filterMap.put("/api/insertRecipel", "anon"); 
        filterMap.put("/api/updateDispensingInfo", "anon");
...
//        kickoutSessionFilter.setKickoutUrl("/login?kickout=1");
        kickoutSessionFilter.setKickoutUrl("/login/login?kickout=1");
