...
public class MyRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        // 调用数据层
        MedicalOrgUser sysUser = medicalOrgUserService.findByLoginName(username);
        ...
        // 返回密码
        return new SimpleAuthenticationInfo(sysUser, sysUser.getLoginPwd(), ByteSource.Util.bytes(username), getName());
